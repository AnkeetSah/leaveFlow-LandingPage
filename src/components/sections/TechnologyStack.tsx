    ...
    >
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Card
              ...
              icon={
                activeTab === "frontend" ? (
                  <RiReactjsLine className="text-blue-600 text-2xl" />
                ) : activeTab === "backend" ? (
                  <RiServerLine className="text-green-600 text-2xl" />
                ) : (
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-24 bg-white/80 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200 p-3 md:p-12 "
        >
          <h3 className="md:text-3xl text-xl  font-extrabold text-gray-900 mb-8 relative inline-block">
            System Architecture
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"></span>
          </h3>

          <div className="bg-gradient-to-br from-blue-100 to-indigo-200 rounded-2xl flex justify-center items-center md:p-10 p-3 shadow-inner">
            <div className="w-full p-4 bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                className="w-full rounded-xl transform transition-transform duration-500 "
