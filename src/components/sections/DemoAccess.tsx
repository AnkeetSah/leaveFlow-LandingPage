...
const DemoAccess = () => {
  ...
  const copyAllCredentials = () => {
    const credential =
      demoCredentials[selectedRole as keyof typeof demoCredentials];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://leaveflow-app-backend.onrender.com/api/add-user/auto",
        {
          method: "POST",
          headers: {
      ...
      <div className="mx-auto max-w-7xl relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Test drive the complete LeaveFlow system using the demo credentials
            below. Copy and paste them on the login page.
          </p>
              ...
              <div className="mb-8 bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <ol className="space-y-3 text-sm text-blue-800">
                  <li className="flex items-start">
                    ...
                    <span>
                      Copy the credentials below for your desired role
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-bold mr-3 flex-shrink-0">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      Explore the demo environment (resets every 2 hours)
                    </span>
                  </li>
                </ol>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-center mb-2">
                          <div
                            className={`w-8 h-8 ${roleColor.bg} rounded-lg flex items-center justify-center`}
                          >
                            {role.icon}
                          </div>
                        </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-semibold text-gray-900">
                    Credentials for {currentCredential.role}
                  </h4>
                  <button
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(currentCredential.email, "email")
                      }
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(currentCredential.password, "password")
                      }
                      className="p-2 text-gray-400 hover:text-gray-600 transition-colors"
                      title="Copy password"
                    >
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">
                  Need Custom Demo Access?
                </h3>
                <p className="text-gray-600">
                  Get personalized credentials for extended testing
                </p>
              </div>
            </div>
            ...
            {!showCustomForm ? (
              <div className="space-y-4">
                <p className="text-gray-600">
                  For institutions wanting to thoroughly evaluate LeaveFlow, we
                  provide customized demo access with:
                </p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 text-blue-800">
            <div>
              ...
              <p className="text-sm">
                All demo activities are completely isolated from production
                data. Your testing won't affect real systems.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-2">Automatic Reset</h4>
              <p className="text-sm">
                Demo data resets every 2 hours, ensuring a clean testing
            ...
            <div>
              ...
              <p className="text-sm">
                Critical operations are simulated - no actual changes are made
            ...
            <div>
              ...
              <p className="text-sm">
                Our team monitors demo usage to prevent abuse and ensure optimal
                performance for all testers.
              </p>
            </div>
          </div>
        </motion.div>
